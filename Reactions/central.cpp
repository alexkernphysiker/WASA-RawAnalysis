	...
	res.Trigger(tn).post()<<(make_shared<ChainCheck>()
		...
		<< ( make_shared<ChainCheck>()
			...
			<< make_shared<SetOfHists1D>("He3nCentralGammas2","TIM4",Q_axis_full(res),he3ggimdiff)
		        ...
		        <<(make_shared<ChainOr>()
                            << ( make_shared<ChainCheck>()                                                                                                                                                  
                                <<[he3ggimdiff](WTrack&T)->bool{return (he3ggimdiff(T)>0.00);}
			    ...
			    << ( make_shared<ChainCheck>()
                	        <<[he3ggimdiff](WTrack&T)->bool{return (he3ggimdiff(T)>0.02);}
				...
				<< make_shared<SetOfHists1D>("He3nCentralGammas2","TIM51",Q_axis_full(res),he3ggimdiff)
                            ...
                            << ( make_shared<ChainCheck>()                                                            
                                <<[he3ggimdiff](WTrack&T)->bool{return (he3ggimdiff(T)>0.04);}                        
                            ...
                            << ( make_shared<ChainCheck>()                                                            
                                <<[he3ggimdiff](WTrack&T)->bool{return (he3ggimdiff(T)>0.06);}                        
                            ...
                            << ( make_shared<ChainCheck>()                                                            
                                <<[he3ggimdiff](WTrack&T)->bool{return (he3ggimdiff(T)>0.08);}                        
                            ...
                            << ( make_shared<ChainCheck>()                                                            
                                <<[he3ggimdiff](WTrack&T)->bool{return (he3ggimdiff(T)>0.10);}                        
                                << make_shared<Hist1D>("He3nCentralGammas2","Events55",Q_axis_full(res))              
                                << make_shared<SetOfHists1D>("He3nCentralGammas2","t55",Q_axis_full(res),ggt)         
                                << make_shared<SetOfHists1D>("He3nCentralGammas2","dt55",Q_axis_full(res),ggdt)       
                                << make_shared<SetOfHists1D>("He3nCentralGammas2","He3MM55",Q_axis_full(res),he3mm)   
                                << make_shared<SetOfHists1D>("He3nCentralGammas2","GIM55",Q_axis_full(res),ggim)      
                                << make_shared<SetOfHists1D>("He3nCentralGammas2","GMM55",Q_axis_full(res),ggmm)      
                                << make_shared<SetOfHists1D>("He3nCentralGammas2","TIM55",Q_axis_full(res),he3ggimdiff)
                            )
                       )
		)
	    )
